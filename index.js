...
p.innerHTML = '<label for="interval">frissítés</label><input type="number" id="interval" value="60"><label for="scroll">Auto scroll</label><input type="checkbox" id="scroll"><input type="button" value="Refresh" onClick="refresh();">';
